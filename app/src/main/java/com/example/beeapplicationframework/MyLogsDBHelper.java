...
public class MyLogsDBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertLog(String species, String pic, String head, String thorax, String abdomen, String f_shape,
    ...
    public boolean updateLog(Integer id, String species, String pic, String head, String thorax, String abdomen, String f_shape,
                             String f_color, String time) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(LOG_COLUMN_SPECIES, species);
