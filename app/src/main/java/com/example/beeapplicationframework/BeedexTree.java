...
public class BeedexTree {
    ...
    BeedexNode affinisNode = new BeedexNode("Bombus affinis", "Rusty-patched bumble bee", "affinis",
    ...
    BeedexNode bimaculatusNode = new BeedexNode("Bombus bimaculatus", "Two-spotted bumble bee", "bimaculatus",
    ...
    BeedexNode fervidusNode = new BeedexNode("Bombus fervidus", "Yellow bumble bee", "fervidus",
            "-",
            "May - October",
    ...
    BeedexNode griseocollisNode = new BeedexNode("Bombus griseocollis", "Brown-belted bumble bee", "griseocollis",
    ...
    BeedexNode impatiensNode = new BeedexNode("Bombus impatiens", "Common Eastern bumble bee", "impatiens",
    ...
    BeedexNode pennsylvanicusNode = new BeedexNode("Bombus pennsylvanicus", "American bumble bee", "pennsylvanicus",
            "terricola",
            "May - October",
    ...
    BeedexNode perplexusNode = new BeedexNode("Bombus perplexus", "Confusing bumble bee", "perplexus",
            "vagans",
            "April - September",
    ...
    BeedexNode ternariusNode = new BeedexNode("Bombus ternarius", "Tri-colored bumble bee", "ternarius",
            "-",
            "April - October",
    ...
    BeedexNode terricolaNode = new BeedexNode("Bombus terricola", "Yellow-banded bumble bee", "terricola",
            "pennsylvanicus",
            "April - October",
    ...
    BeedexNode vagansNode = new BeedexNode("Bombus vagans", "Half-black bumble bee", "vagans",
            "perplexus",
            "April - October",
